                        ...
                        <div className="mega-menu-container hybrid-layout">
                            ...
                            <div className="mega-col mega-right-col">
                                ...
                                <ul className="mega-list-curated">
                                    ...
                                    <li><Link href="/trips/bhutan-family-adventure" onClick={handleMenuLinkClick}>Bhutan Family Adventure</Link></li>
                                    <li><Link href="/trips/nature-retreat" onClick={handleMenuLinkClick}>Nature Retreat</Link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
